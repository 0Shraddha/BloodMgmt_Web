...
const BloodInventory = ({ centerData = null }) => {
  ...
  const [centerValues, setCenterValues] = useState({
    centerId: centerData ? centerData.centerId : '',
    bloodType: centerData ? centerData.bloodType : '',
    units: centerData ? centerData.units : '',
    ...
    <>
      ...
      <div className="add-container px-5 py-4 mb-5">
        ...
        <form onSubmit={handleSubmit} className="addBloodDataForm">
              ...
              >
                ...
                {centerList.map((center) => (
                  <option key={center._id} value={center._id}>
                    {center.centerName} {/* Assuming center object has a 'centerName' property */}
                  </option>
                ))}
              </select>
            </div>
          ...
          <div>
            <button className="btn my-3" style={{ width: '100%' }} id="btnAdd">
